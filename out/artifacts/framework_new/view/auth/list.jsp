            ...
            <div class="row-fluid">
                <form method="post" name="form1" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" ng-model="auth.authName" required="true"  style="width: 100%;" placeholder="请输入名称">
                    </div>
                    <div class="form-group">
                        <label for="name">权限类型</label>
                        <select id="authType"  ng-model="auth.authType"   style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="authUrl" ng-model="auth.authUrl"  style="width: 100%;" placeholder="请输入url">
                    </div>
                    <div class="form-group">
                        <label for="authUrl">权限描述:</label>
                        <textarea style="width: 100%;" id="authDesc" ng-model="auth.authDesc"  class="form-control"
                                  rows="5"></textarea>
                    </div>
            </div>
        </div>
